...
int main(void)
{
  ...
  RUN_TEST(test_stringIsEqual_should_return_one_if_both_string_is_same, 631);
  RUN_TEST(test_stringIsEqual_should_return_one_if_both_string_is_same01, 652);
  RUN_TEST(test_stringIsEqual_should_return_zero_if_both_string_is_same02, 673);
  RUN_TEST(test_stringIsEqualCaseInsensitive_should_set_all_alphabet_to_lower_case, 694);
  RUN_TEST(test_stringIsEqualCaseInsensitive_should_set_all_alphabet_to_lower_case2, 715);
  RUN_TEST(test_stringIsEqualCaseInsensitive_should_set_all_alphabet_to_lower_case01, 736);
  RUN_TEST(test_stringCharAt_should_return_negative_one_if_startIndex_is_more_than_lenght, 757);
  RUN_TEST(test_stringCharAt_should_return_relative_character, 766);
  RUN_TEST(test_stringCharAt_should_return_relative_character2, 778);
  RUN_TEST(test_stringCharAtInSet_should_return_negative_one, 790);
  RUN_TEST(test_stringCharAtInSet_should_return_relative_character2, 801);
  RUN_TEST(test_stringCharAtInSet_should_return_relative_character3, 812);
  RUN_TEST(test_stringSubstringInChar_Phone016_should_return_016, 823);
  RUN_TEST(test_stringSubstringInChar2_HandPhone016123_should_return_016, 835);
  RUN_TEST(test_stringSubstringInChar_Phone016_should_return_NULL_if_length_of_string_exceeded, 847);
  RUN_TEST(test_stringSubstringInText_Phone016_should_return_016, 859);
  RUN_TEST(test_stringSubstringInText_should_get_substring, 872);
  RUN_TEST(test_stringSubstringInText_should_return_empty_string, 885);
  RUN_TEST(test_stringToInteger_should_return_integer_type, 898);
  RUN_TEST(test_stringToInteger_should_return_integer_type2, 910);
  RUN_TEST(test_stringToInteger_should_return_integer_type3, 922);
