...
extern void test_getToken_should_get_number_token_from_string_with_space_infront_and_left_empty_space(void);
...
int main(void)
{
  ...
  RUN_TEST(test_getToken_should_get_number_token_from_string_with_space_infront_and_left_empty_space, 24);
  RUN_TEST(test_getToken_should_get_234_from_string_with_space_in_between_and_left_space567, 35);
  RUN_TEST(test_getToken_should_get_234_from_string_contain_alphabets_with_space_in_between_and_left_spacejason, 48);
  RUN_TEST(test_getToken_should_throw_error_when_characters_is_behind, 58);
  RUN_TEST(test_getToken_should_throw_error_from_string_combine_with_alphabets_and_operators, 71);
  RUN_TEST(test_getToken_should_throw_an_error_for_string_start_with_alphabet_first, 84);
  RUN_TEST(test_getToken_should_get_operator_token_and_return_ADD_OP_and_left_empty_space, 96);
  RUN_TEST(test_getToken_should_get_operator_token_with_space_at_front_and_return_ADD_OP_and_left_empty_space, 109);
  RUN_TEST(test_getToken_should_get_operator_token_and_number_token, 122);
  RUN_TEST(test_getToken_should_get_operator_token_number_token_and_identieifer_token, 149);
  RUN_TEST(test_getToken_should_throw_error_for_string_operator_and_characters, 177);
  RUN_TEST(test_getToken_should_get_operators_token_and_return_LOGICAL_AND_OP_and_left_empty_space, 190);
  RUN_TEST(test_getToken_should_get_operators_token_and_return_LOGICAL_AND_OP_and_left_empty_space_and_characters_and_numbers, 204);
  RUN_TEST(test_getToken_should_get_operators_token_with_space_at_front_and_return_LOGICAL_AND_OP_and_left_empty_space_and_characters_and_numbers, 218);
  RUN_TEST(test_getToken_should_get_operators_token_and_return_LOGICAL_OR_OP_and_left_empty_space, 230);
  RUN_TEST(test_getToken_should_get_operators_token_and_return_LOGICAL_OR_OP_and_left_empty_space_and_characters, 243);
  RUN_TEST(test_getToken_should_get_two_different_operators_token_and_throw_an_error, 257);
  RUN_TEST(test_getToken_should_get_two_different_operators_token_and_throw_an_error2, 270);
  RUN_TEST(test_getToken_should_get_space_between_two_different_operators_token_and_throw_an_error, 283);
  RUN_TEST(test_getToken_should_get_identifier_token_from_string, 298);
  RUN_TEST(test_tokenDel_should_delete_Number_token_and_return_empty_string, 309);
  RUN_TEST(test_tokenDel_should_delete_Identifier_token_and_return_empty_string, 319);
  RUN_TEST(test_tokenDel_should_delete_Operator_token_and_return_empty_string, 328);
  RUN_TEST(test_tokenDel_should_getToken_for_left_parenthesis, 338);
