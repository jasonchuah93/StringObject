...
int main(void)
{
  ...
  UnityBegin();
  RUN_TEST(test_numberNew_should_get_single_digit_value_and_type, 15);
  RUN_TEST(test_numberNew_should_get_more_than_single_digit_value_and_type, 25);
  RUN_TEST(test_numberNew_should_get_negative_value_and_type, 35);
  RUN_TEST(test_identifierNew_should_identifier_the_content, 45);
  RUN_TEST(test_identifierNew_should_identifier_the_content2, 56);
  RUN_TEST(test_identifierNew_should_identifier_the_content_three, 67);
  RUN_TEST(test_operatorNewBySymbol_should_identify_the_symbol, 79);
  RUN_TEST(test_operatorNewBySymbol_should_identify_the_different_symbol, 91);
  RUN_TEST(test_operatorNewBySymbol_should_identify_the_different_symbol2, 103);
  RUN_TEST(test_operatorNewBySymbol_should_identify_the_different_symbol3, 115);
  RUN_TEST(test_operatorNewBySymbol_should__retur_NULL_if_input_invalid_symbol, 127);
  RUN_TEST(test_operatorNewBySymbol_should_identify_the_different_symbol4, 135);
  RUN_TEST(test_operatorNewByID_should_identify_the_different_symbol, 148);
  RUN_TEST(test_operatorNewByID_should_identify_the_different_symbol2, 158);
  RUN_TEST(test_operatorNewByID_should_identify_the_different_symbol3, 168);
  RUN_TEST(test_operatorNewByID_should_return_NULL_if_input_the_incorrect_symbol, 177);
